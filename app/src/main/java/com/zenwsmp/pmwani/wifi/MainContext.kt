...
import com.zenwsmp.pmwani.wifi.filter.adapter.FiltersAdapter
import com.zenwsmp.pmwani.wifi.manager.WiFiManagerWrapper
import com.zenwsmp.pmwani.wifi.scanner.ScannerService
import com.zenwsmp.pmwani.wifi.scanner.makeScannerService
import com.zenwsmp.pmwani.wifi.settings.Repository
import com.zenwsmp.pmwani.wifi.settings.Settings
import com.zenwsmp.pmwani.wifi.vendor.model.VendorService

enum class MainContext {
    INSTANCE;

    lateinit var settings: Settings
    lateinit var mainActivity: AccessPointsActivity
    ...
    fun initialize(activity: AccessPointsActivity, largeScreen: Boolean) {
