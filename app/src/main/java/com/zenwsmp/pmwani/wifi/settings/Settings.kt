 ...
 */
package com.zenwsmp.pmwani.wifi.settings

import android.content.SharedPreferences.OnSharedPreferenceChangeListener
import com.zenwsmp.pmwani.wifi.annotation.OpenClass

import com.zenwsmp.pmwani.wifi.band.WiFiBand
import com.zenwsmp.pmwani.wifi.model.GroupBy
import com.zenwsmp.pmwani.wifi.model.Security
import com.zenwsmp.pmwani.wifi.model.SortBy
import com.zenwsmp.pmwani.wifi.model.Strength
import com.zenwsmp.pmwani.R
import com.zenwsmp.pmwani.wifi.accesspoint.AccessPointViewType
import com.zenwsmp.pmwani.wifi.accesspoint.ConnectionViewType
import com.zenwsmp.pmwani.wifi.util.*
import java.util.*
 ...
 /*   fun channelGraphLegend(): GraphLegend = find(GraphLegend.values(), R.string.channel_graph_legend_key, GraphLegend.HIDE)
   ...
   /* fun selectedMenu(): NavigationMenu = find(NavigationMenu.values(), R.string.selected_menu_key, NavigationMenu.ACCESS_POINTS)
    ...
    private fun <T : Enum<T>> findSet(values: Array<T>, key: Int, defaultValue: T): Set<T> {
        ...
        return com.zenwsmp.pmwani.wifi.util.findSet(values, ordinalSaved, defaultValue)
    }
