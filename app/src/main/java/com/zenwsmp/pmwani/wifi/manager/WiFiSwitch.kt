 ...
 */
package com.zenwsmp.pmwani.wifi.manager

import android.annotation.TargetApi
import android.net.wifi.WifiManager
import android.os.Build
import com.zenwsmp.pmwani.wifi.annotation.OpenClass
import com.zenwsmp.pmwani.wifi.util.buildMinVersionQ
...
class WiFiSwitch(private val wifiManager: WifiManager) {
   ...
   // fun startWiFiSettings(): Unit = MainContext.INSTANCE.mainActivity;
